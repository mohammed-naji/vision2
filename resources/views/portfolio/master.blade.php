...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="{{ route('port.index') }}">Start Bootstrap</a>
...
{{-- @if (request()->routeIs('port.portfolio'))
{{ 'active' }}
@else
{{ '' }}
@endif --}}
{{ request()->routeIs('port.portfolio') ? 'active' : '' }}
                            " href="{{ route('port.portfolio') }}">Portfolio</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded
{{ request()->routeIs('port.about') ? 'active' : '' }}
                            " href="{{ route('port.about') }}">About</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded
{{ request()->routeIs('port.contact') ? 'active' : '' }}
                            " href="{{ route('port.contact') }}">Contact</a></li>
                    </ul>
                </div>
            </div>
        </nav>
